    ...
    while !win.should_close() {
        ...
        match currentscreen {
            ...
            GameScreen::Gameplay => {
                ...
                win.draw_text("Move your rectangle with WASD", 100, 100, 25, ORANGE);
                win.draw_rectangle_v(rectpos, rectsize, WHITE);
                win.draw_text("Player 1", rectpos.x as usize, rectpos.y as usize, 20, BLACK);
                if win.is_key_pressed(Key::Enter) {
