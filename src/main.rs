...
use raylib_sys::{
    DrawRectangleRec, GetScreenHeight, IsKeyDown, KeyboardKey_KEY_LEFT_SHIFT, Rectangle,
};
...
fn main() {
    unsafe {
        ...
        let mut box_a = Rectangle {
            x: 10.,
            y: (GetScreenHeight() as f32 / 2. - 50.) as f32,
            width: 200.,
            height: 100.,
        };
        ...
        while !win.should_close() {
            ...
            match currentscreen {
                ...
                GameScreen::Gameplay => {
                    let fac = if IsKeyDown(KeyboardKey_KEY_LEFT_SHIFT as i32) {
                        2.0
                    } else {
                        1.0
                    };
